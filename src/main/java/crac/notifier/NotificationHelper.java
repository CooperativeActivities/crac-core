...
public class NotificationHelper {
	...
	public static EvaluateSelf createSelfEvaluation(CracUser target, Task task, Evaluation evaluation) {
		EvaluateSelf e = new EvaluateSelf(target.getId(), task.getId(), evaluation.getId());
